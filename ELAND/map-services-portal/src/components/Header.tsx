      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex justify-between items-center">
          ...
          <ul className="hidden md:flex gap-8">
            ...
            <li><a href="https://gps.eland.mn/track/Track" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-blue-600 font-medium">GPS Хяналтын систем</a></li>
          </ul>
